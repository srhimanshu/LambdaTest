...
public class TestLT
{
	...
	public void launchURL() throws InterruptedException
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='plyr__controls']/button")));
	}
	...
	public void playVideo() throws InterruptedException
	{
    	...
    	wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@data-instance-key='1439_4bf2c664-2204-45f5-9158-23ece304bc0f']/div")));
		actions.moveToElement(driver.findElement(By.xpath("//div[@class='plyr__controls']/button"))).click().perform();
//		click("//button[@class='plyr__control plyr__control--overlaid']");
    ...
    void assertSAM(String clickableandWaitXpath) throws InterruptedException {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(clickableandWaitXpath)));
		driver.findElement(By.xpath(clickableandWaitXpath)).click();

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//i[contains(text(),'close')]")));
